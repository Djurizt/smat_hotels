...
const getClient = (req, res) => {
    ...
    clientModels.getClientDetailsByEmailAndPhone(email, phone_number)
    .then(clientDetails =>{
...
const createClient = (req, res) => {
 ...
 //const {firstname, othernames, email, phone_number, password, gender, Next_of_kin, Next_of_kin_Address} = req. body
    ...
    clientModels.checkClient(req.body.email, req.body.phone_number)
    ...
    req.body.password = responseFromHashPassword
        ...
        return clientModels.newClient(req.body)
    ...
    .then(newClientResult=>{
       ...
       clientModels.insertOtp(otp, req.body.customer_id)
